...
def calculate(ans, numbers):
    ...
    # concatenation of numbers[0], numbers[1]
    conc = int(str(numbers[0]) + str(numbers[1]))
    new_array3 = [conc] + numbers[2:]

    return calculate(ans, new_array1) or calculate(ans, new_array2) or calculate(ans, new_array3)
